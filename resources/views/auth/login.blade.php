...
<head>
    ...
    <meta name="description" content="Haris Tanone">
    <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="/assets/login_style/css/style.css">
</head>
...
<body>
                ...
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="731.67004" height="333.99672"
                                viewBox="0 0 731.67004 625.99672" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <path id="uuid-5ef434d5-ec3b-4be2-96d4-c13c471d6de8-95"
                                ...
                                <path
                                    ...
                                    fill="#2f2e43" />
                                <g>
                                    <circle cx="359.29443" cy="229.27966" r="85.24289" fill="#ff5746" />
                                    <g>
                                        <path
                                ...
                                <path
                                    d="M0,624.38336c0,.66003,.53003,1.19,1.19006,1.19H730.48004c.65997,0,1.19-.52997,1.19-1.19,0-.65997-.53003-1.19-1.19-1.19H1.19006c-.66003,0-1.19006,.53003-1.19006,1.19Z"
                                    fill="#3f3d58" />
                                <path id="uuid-ed8d5917-2465-4251-8a73-24d647765b28-96"
    ...
    <script src="/assets/login_style/js/jquery.min.js"></script>
    <script src="/assets/login_style/js/popper.js"></script>
    <script src="/assets/login_style/js/bootstrap.min.js"></script>
    <script src="/assets/login_style/js/main.js"></script>
</body>
